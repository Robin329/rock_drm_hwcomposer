...
##################for rk3399_firefly_sr_c11g_jd4#####################
ifeq ($(strip $(TARGET_PRODUCT)),rk3399_firefly_sr_c11g_jd4)
LOCAL_CFLAGS += -DENABLE_GENERATE_REGULAR_ADB_DEVICE_NAME
endif

##################for rk3399_firefly_cs_r2#####################
ifeq ($(strip $(TARGET_PRODUCT)),rk3399_firefly_cs_r2)
LOCAL_CFLAGS += -DENABLE_GENERATE_REGULAR_ADB_DEVICE_NAME
endif
