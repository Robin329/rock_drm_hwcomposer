...
#define RKNAND_GET_SN_SECTOR       _IOW('d', 3, unsigned int)//��ȡSN
...
int rknand_sys_storage_lock_loader(void)
{
    ...
    sysData.len = 0; //���ֵ��һ�����룬�û��Լ����ã�Ĭ�����ֵΪ0��û�����룬��һ������ʱ�����ֵ�ᱣ�棬unlockʱ���ֵҪƥ��
...
int rknand_sys_storage_unlock_loader(void)
{
    ...
    sysData.tag = LOADER_LOCK_UNLOCK_TAG;
    sysData.len = 0; //���ֵ��һ�����룬unlockʱҪƥ�����룬���벻ƥ�䲻��unlock���ɹ�unlock����������
...
#define CORE_ADC_PATH "/sys/bus/iio/devices/iio:device0/in_voltage0_raw"
